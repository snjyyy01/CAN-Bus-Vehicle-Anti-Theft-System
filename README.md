...
1. IR sensor detects intrusion.
2. ESP32 processes the sensor data.
3. Data is transmitted through the CAN Bus.
4. LoRa communicates with the user module.
5. GPS provides vehicle location.
6. User controls Lock, Unlock, and Parking modes through the web interface.
7. Relay performs engine lockdown when required.
